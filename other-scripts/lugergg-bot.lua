...
local A_1 = "LUGER GG BOT LOADING." local A_2 = "All"
local Event = game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest Event:FireServer(A_1, A_2) 
wait(0.5)
A_1 = "LUGER GG BOT FETCHING SCRIPT."
local Event = game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest Event:FireServer(A_1, A_2) 
wait(2)
A_1 = "LUGER GG BOT LOADED EXECUTING."
local Event = game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest Event:FireServer(A_1, A_2) 
wait(2)
A_1 = "LUGER GG BOT PLEASE DO NOT GET MAD, THIS IS SIMPLY A BOT."
local Event = game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest Event:FireServer(A_1, A_2) 
--// Setting \\--
local range = 15
...
game:GetService("RunService").RenderStepped:Connect(function()
    ...
    for i = 2, #p do local v = p[i].Character
		...
		print('voidz.xyz get voidz like an exploiter noob')
...
game:GetService("RunService").RenderStepped:connect(function()
    ...
    if s then
		...
		while true do
 wait(5)
     local A_1 = "Buy Cheap Time and Mystery Mystery 2 Godlies at LUGER.GG"
local Event = game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest Event:FireServer(A_1, A_2) 
--local A_1 = "Buy Cheap Time and Mystery Mystery 2 Godlies at LUGER (DOT) GG" local A_2 = "All" 
